...
Issues with trackpad (no zoom​ gesture, lag) | Temp fix: Use a usb mouse
Audio issues (Turns off randomly) | Temp fix: in your macOS go to: "System preferences > Sound" then try
